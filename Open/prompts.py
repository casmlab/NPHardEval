...
mfpPrompts = {
    ...
    "Finetune_content": "Please indicate the maximum flow value and the flow for each edge.",
    "Finetune_format": "Enclose your output within <root></root> tags. Include the final maximum flow and edge flows in <final_answer></final_answer> tags.",
    ...
    "Output_format": """Enclose your output within <root></root> tags. Present your reasoning in <reasoning></reasoning> tags and the final maximum flow and edge flows in <final_answer></final_answer> tags.
Below are two examples with null content but correct formating: 
<example1>
<root>
<reasoning>
...
<final_answer>
{'MaxFlow': 'i', 'Flows': {'0->1': 4, ... ... '2->3': 1}} (where 'i' is the max flow value, and the dictionary is an example of flow for each edge)
</final_answer>
</root>
</example1>
...
<final_answer>
{'MaxFlow': 'j', 'Flows': {'8->1': 1, ... ... '3->6': 1}} (where 'j' is the max flow value, and the dictionary is an example of flow for each edge)
</final_answer>
</root>
</example2>
...
bspPrompts = {
    ...
    "Finetune_content": "Please identify the position of the target value in the array.",
    "Finetune_format": "Your output should be enclosed in <root></root> tags. Include the final position of the target value in <final_answer></final_answer> tags, like <final_answer>{'Position': 'TARGET_POSITION'}</final_answer>.",
    "Few_shot_self": "",
    "Few_shot_others": ""
}
...
edpPrompts = {
    ...
    "Few_shot_self": "",
    "Few_shot_others": "",
    "Finetune_content": "Please provide the minimum number of operations required to transform the first string into the second string.",
    "Finetune_format": "Your output should be enclosed in <root></root> tags. Include the final minimum number of operations in <final_answer></final_answer> tags, like <final_answer>{'Operations': 'MINIMUM_NUMBER_OF_OPERATIONS'}</final_answer>.",
}
...
tsp_dPrompts = {
    ...
    "Few_shot_self": "",
    "Few_shot_others": "",
    "Finetune_content": "Provide a yes or no answer.",
    "Finetune_format": "Your output should be enclosed in <root></root> tags. Include the final yes/no answer in <final_answer></final_answer> tags, like <final_answer>{'Feasible': 'YES_OR_NO'}</final_answer>.",
}
...
kspPrompts = {
    ...
    "Few_shot_self": "",
    "Few_shot_others": "",
    "Finetune_content": "Indicate if an optimal subset exists and its total value.",
    "Finetune_format": "Your output should be enclosed in <root></root> tags. Include the final decision and total value in <final_answer></final_answer> tags, like <final_answer>{'Feasible': 'YES_OR_NO', 'TotalValue': 'TOTAL_VALUE'}</final_answer>.",
}
...
tspPrompts = {
    ...
    "Few_shot_self": "",
    "Few_shot_others": "",
    "Finetune_content": "Please list each city in the order they are visited.",
    "Finetune_format": "Your output should be enclosed in <root></root> tags. Include the final output of the result path and total distance wrapped by final_answer tag, like <final_answer>{'Path': '0->1->2->...->N->0', 'TotalDistance': 'INT_TOTAL_DISTANCE'}</final_answer>",
}
...
gcpPrompts = {
    ...
    "Few_shot_self": "",
    "Few_shot_others": "",
    "Finetune_content": "Please label every vertex, even if it is disconnected from the rest of the graph. ",
    "Finetune_format": "Your output should be enclosed in <root></root> tags. Include the final output of all vertex numbers and their associated colors, wrapped by final_answer tag, like <final_answer>{0:'COLOR_1', 1:'COLOR_2', ...}</final_answer>.",
}
...
mspPrompts = {
    ...
    "Few_shot_self": "",
    "Few_shot_others": "",
    "Finetune_content": "Please provide a time slot where all participants can attend the meeting.",
    "Finetune_format": "Your output should be enclosed in <root></root> tags. Include the final output of meeting numbers followed by a list of slots, like <final_answer>{0:[1,2], 1:[4], ...}</final_answer>.",
}
